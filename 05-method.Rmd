...
```{r fig42a, fig.cap='Flood Detection General Workflow',echo=FALSE, message=FALSE, warning=FALSE, out.width='70%', fig.asp=.75, fig.align='center'}
knitr::include_graphics("img/fig41_workflow.png")
```
...
```{r fig42b, fig.cap='ALOS-2 radiometric and geometric calibration Workflow',echo=FALSE, message=FALSE, warning=FALSE, out.width='70%', fig.asp=.75, fig.align='center'}
knitr::include_graphics("img/fig41_workflow1.png")
```
...
```{r fig42c, fig.cap='ALOS-2 radiometric calibration formula',echo=FALSE, message=FALSE, warning=FALSE, out.width='70%', fig.asp=.75, fig.align='center'}
knitr::include_graphics("img/fig41_workflow2.png")
```

- To do image filtering with Lee filter (5x5 window size).

```{r fig42d, fig.cap='ALOS-2 speckle reduction',echo=FALSE, message=FALSE, warning=FALSE, out.width='70%', fig.asp=.75, fig.align='center'}
knitr::include_graphics("img/fig42_workflow3.png")
```

- To convert coordinate to GCS_WGS_1984

```{r fig42e, fig.cap='Reprojection to GCS WGS84',echo=FALSE, message=FALSE, warning=FALSE, out.width='70%', fig.asp=.75, fig.align='center'}
knitr::include_graphics("img/fig42_workflow4.png")
```
...
```{r fig42f, fig.cap='Image differencing',echo=FALSE, message=FALSE, warning=FALSE, out.width='70%', fig.asp=.75, fig.align='center'}
knitr::include_graphics("img/fig42_workflow5.png")
```
...
```{r fig42g, fig.cap='Image thresholding',echo=FALSE, message=FALSE, warning=FALSE, out.width='70%', fig.asp=.75, fig.align='center'}
knitr::include_graphics("img/fig42_workflow6.png")
```
...
```{r fig42h, fig.cap='Image filtering',echo=FALSE, message=FALSE, warning=FALSE, out.width='70%', fig.asp=.75, fig.align='center'}
knitr::include_graphics("img/fig42_workflow6.png")
```
...
```{r fig52a, fig.cap='Create New Profile in BitVise SSH Client',echo=FALSE, message=FALSE, warning=FALSE, out.width='70%', fig.asp=.75, fig.align='center'}
knitr::include_graphics("img/fig52a.png")
```
...
```{r fig52b, fig.cap='Saving the new profile',echo=FALSE, message=FALSE, warning=FALSE, out.width='70%', fig.asp=.75, fig.align='center'}
knitr::include_graphics("img/fig52b.png")
```
...
```{r fig52c, fig.cap='Completing the profile',echo=FALSE, message=FALSE, warning=FALSE, out.width='70%', fig.asp=.75, fig.align='center'}
knitr::include_graphics("img/fig52c.png")
```

-- Click Login 

```{r fig52d, fig.cap='BitVise xterm',echo=FALSE, message=FALSE, warning=FALSE, out.width='70%', fig.asp=.75, fig.align='center'}
knitr::include_graphics("img/fig52d.png")
```

```{r fig52e, fig.cap='BitVise SFTP',echo=FALSE, message=FALSE, warning=FALSE, out.width='70%', fig.asp=.75, fig.align='center'}
knitr::include_graphics("img/fig52e.png")
```
...
```{r fig44a, fig.cap='Downloading DEM for GMT5SAR processing',echo=FALSE, message=FALSE, warning=FALSE, out.width='70%', fig.asp=.75, fig.align='center'}
knitr::include_graphics("img/topo.png")
```
...
```{r fig52g, fig.cap='Uploading ALOS-2 data to raw folder',echo=FALSE, message=FALSE, warning=FALSE, out.width='70%', fig.asp=.75, fig.align='center'}
knitr::include_graphics("img/fig52g.png")
```

- Extract the files downloaded from DEM Generation process in GMTSAR website and copy all of the files to topo folder.


```{r fig52f, fig.cap='Uploading DEM files to topo folder',echo=FALSE, message=FALSE, warning=FALSE, out.width='70%', fig.asp=.75, fig.align='center'}
knitr::include_graphics("img/fig52f.png")
```
